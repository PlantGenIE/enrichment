...
function main(o, data) {
  ...
  $('#gene_ontology_treemap').width(opts.width).height(opts.height);
  var width = opts.width - margin.left - margin.right,
	...
	var colorRange = ["#ffff00","#ffbb00","#ffaa11","#ff9900","#ff7700","#ff5500","#ff3300","#aa0000","#aa0000"];//cc2222
  
var color = d3.scale.linear()
		.domain(colorDomain)
		.range(colorRange
			/*function(d){ console.log(d.pvalue);
			return d.colorRange
		}*/
			);	
...
//}
  ...
  function display(d) {
	...
	.style("fill", function(d){ if(d.parent.key=="Gene Ontology"){return "white"}else{return "white"}  }) 
        .attr("dy", ".75em")
