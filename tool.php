...
<span style="position: absolute" id="enrichment_waiting"><img width="160px" src="plugins/gene/css/load1.gif" /></span>
 <script  src="plugins/enrichment/js/jquery.dataTables.min.js"></script>
  <script  src="plugins/enrichment/js/init.js"></script>
     <link rel="stylesheet" type="text/css" href="plugins/enrichment/css/jquery.dataTables.min.css">
     <link rel="stylesheet" type="text/css" href="plugins/enrichment/css/style.css">
     <link rel="stylesheet" type="text/css" href="plugins/enrichment/css/treemap.css">

    
     
       <div id="gene_ontology_treemap" style="width: 100%"></div>
...
<table style="float: right;display: none" id="scale_table"  border="0" cellspacing="0" cellpadding="4" width="890px"> 
 ...
 <div class="container_tmp">
    ...
    <!-- <h4 id="kegg_label">KEGG</h4>
    <table id="kegg_table"></table>-->
</div>
 <br>
  </div>
	
<script src="//d3js.org/d3.v3.min.js"></script> 
<script src="plugins/enrichment/js/treemap.js"></script>  
